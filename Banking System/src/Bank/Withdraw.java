...
public class Withdraw extends javax.swing.JFrame {
    ...
    int ind=0;
    Withdraw(ArrayList<Account> List, int index) {
        this();
        data =List;
        ind= index;
        
        currentBalance.setText(String.valueOf(data.get(ind).getBalance()));
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 100, 96, 24));
        ...
        getContentPane().add(currentBalance, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 100, 129, -1));

        jLabel2.setFont(new java.awt.Font("Segoe UI Black", 1, 18)); // NOI18N
        jLabel2.setText("Amount");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 180, 99, 62));
        ...
        getContentPane().add(Amount, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 190, 190, 37));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 250, 112, 43));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 350, 81, 40));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
         ...
         if (balance - Double.parseDouble(Amount.getText())<0) {
        ...
        FileOutputStream fout;
            ...
            Amount.setText(null);
            JOptionPane.showMessageDialog(Withdraw.this,"Successfully Withdrawn!!!");
